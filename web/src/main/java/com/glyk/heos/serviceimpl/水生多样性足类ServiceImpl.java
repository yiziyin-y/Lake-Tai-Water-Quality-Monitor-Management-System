...
import com.glyk.heos.service.水生多样性足类Service;
...
@Service
public class 水生多样性足类ServiceImpl implements 水生多样性足类Service {
    @Override
    public Result get水生多样性足类Report(String place, int col) {
        Result result=new Result();
        Map resultMap=new HashMap();
        水生多样性足类Example s水生多样性足类Example=new 水生多样性足类Example();
        水生多样性足类Example.Criteria criteria=s水生多样性足类Example.createCriteria().and采样点位EqualTo(place);
        List<水生多样性足类> 水生多样性足类List=s水生多样性足类Mapper.selectByExample(s水生多样性足类Example);
        List<String> timelist=new ArrayList<String>();
        List<Double> reslist=new ArrayList<Double>();
        String[] fieldList=EntityUtil.getClassColmun("com.glyk.heos.dal.dao.水生多样性足类");
        String value="";
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM");
        for (水生多样性足类 data:水生多样性足类List)
        {
    ...
    @Resource
    水生多样性足类Mapper s水生多样性足类Mapper;
    @Override
    public Result get水生多样性足类Info(Date startDate, Date endDate, int pageIndex, int pageSize) {
        Result result = new Result();
        Map resultMap =  new HashMap();
        水生多样性足类Example s水生多样性足类Example = new 水生多样性足类Example();
        水生多样性足类Example.Criteria criteria = s水生多样性足类Example.createCriteria().and日期Between(startDate,endDate);
        PageHelper.startPage(pageIndex,pageSize);
        List<水生多样性足类> 水生多样性足类List = s水生多样性足类Mapper.selectByExample(s水生多样性足类Example);
        String[] fieldList = EntityUtil.getClassColmun("com.glyk.heos.dal.dao.水生多样性足类");
        PageInfo pageInfo = new PageInfo(水生多样性足类List);
        resultMap.put("tHead",fieldList);
        resultMap.put("tBody",水生多样性足类List);
    ...
    public boolean deleteRow(int rowId) {
        ...
        水生多样性足类Example s水生多样性足类Example = new 水生多样性足类Example();
        水生多样性足类Example.Criteria criteria = s水生多样性足类Example.createCriteria();
        criteria.andIdEqualTo(rowId);
        int result =   s水生多样性足类Mapper.deleteByExample(s水生多样性足类Example);
    ...
    public boolean updateRow(水生多样性足类 record) {
        ...
        int result=s水生多样性足类Mapper.updateByExampleSelective(record,s水生多样性足类Example);
        return result==1?true:false;
    }
    @Override
    public boolean insert(水生多样性足类 record) {
        int result=s水生多样性足类Mapper.insert(record);
        return result==1?true:false;
    }
...
//        PageHelper.startPage(pageIndex,pageSize);
        List<水生多样性足类> 水生多样性足类List=s水生多样性足类Mapper.selectByExample(s水生多样性足类Example);
        Collections.sort(水生多样性足类List, new Comparator<水生多样性足类>() {
            @Override
            public int compare(水生多样性足类 o1, 水生多样性足类 o2) {
                return o1.get采样点位().compareTo(o2.get采样点位());
            }
        });
        String[] fieldList={"采样点位","平均值","最大值","最小值","标准差"};
        String[] fieldList2=EntityUtil.getClassColmun("com.glyk.heos.dal.dao.水生多样性足类");
    ...
    public Result get水生多样性足类统计Info2(String place, Date startDate, Date endDate) {
        ...
        Map resultMap=new HashMap();
        水生多样性足类Example s水生多样性足类Example=new 水生多样性足类Example();
        水生多样性足类Example.Criteria criteria=s水生多样性足类Example.createCriteria().and日期Between(startDate,endDate).and采样点位EqualTo(place);
//        PageHelper.startPage(pageIndex,pageSize);
        List<水生多样性足类> 水生多样性足类List=s水生多样性足类Mapper.selectByExample(s水生多样性足类Example);
        List<水生多样性足类> 水生多样性足类ListRes=new ArrayList<水生多样性足类>();
        水生多样性足类 d1=new 水生多样性足类();
        水生多样性足类 d2=new 水生多样性足类();
        水生多样性足类 d3=new 水生多样性足类();
        水生多样性足类 d4=new 水生多样性足类();
        String[] fieldList=EntityUtil.getClassColmun("com.glyk.heos.dal.dao.水生多样性足类");
        List<Double> list=new ArrayList<Double>();
        StaDao sta=null;
        String value="";
...
//                System.out.println(sta.getAverage()+" "+sta.getMax()+" "+sta.getMax()+" "+sta.getMin());
        ...
        d3.set采样点位("最小值");
        d4.set采样点位("标准差");
        水生多样性足类ListRes.add(d1);
        水生多样性足类ListRes.add(d2);
        水生多样性足类ListRes.add(d3);
        水生多样性足类ListRes.add(d4);
        PageInfo pageInfo = new PageInfo(水生多样性足类ListRes);
        fieldList[2]="";
        resultMap.put("tHead",fieldList);
        resultMap.put("tBody",水生多样性足类ListRes);
        result.setTotal((int)pageInfo.getTotal());
        result.setRows(resultMap);
        return result;
    }
