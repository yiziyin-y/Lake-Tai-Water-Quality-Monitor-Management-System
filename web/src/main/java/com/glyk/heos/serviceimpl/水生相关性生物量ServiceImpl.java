...
import com.glyk.heos.service.水生相关性生物量Service;
...
@Service
public class 水生相关性生物量ServiceImpl implements 水生相关性生物量Service {
    @Override
    public Result get水生相关性生物量Report(String place, int col) {
        Result result=new Result();
        Map resultMap=new HashMap();
        水生相关性生物量Example s水生相关性生物量Example=new 水生相关性生物量Example();
        水生相关性生物量Example.Criteria criteria=s水生相关性生物量Example.createCriteria().and采样点位EqualTo(place);
        List<水生相关性生物量> 水生相关性生物量List=s水生相关性生物量Mapper.selectByExample(s水生相关性生物量Example);
        List<String> timelist=new ArrayList<String>();
        List<Double> reslist=new ArrayList<Double>();
        String[] fieldList=EntityUtil.getClassColmun("com.glyk.heos.dal.dao.水生相关性生物量");
        String value="";
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM");
        for (水生相关性生物量 data:水生相关性生物量List)
        {
    ...
    @Resource
    水生相关性生物量Mapper s水生相关性生物量Mapper;
    @Override
    public Result get水生相关性生物量Info(Date startDate, Date endDate, int pageIndex, int pageSize) {
        Result result = new Result();
        Map resultMap =  new HashMap();
        水生相关性生物量Example s水生相关性生物量Example = new 水生相关性生物量Example();
        水生相关性生物量Example.Criteria criteria = s水生相关性生物量Example.createCriteria().and日期Between(startDate,endDate);
        PageHelper.startPage(pageIndex,pageSize);
        List<水生相关性生物量> 水生相关性生物量List = s水生相关性生物量Mapper.selectByExample(s水生相关性生物量Example);
        String[] fieldList = EntityUtil.getClassColmun("com.glyk.heos.dal.dao.水生相关性生物量");
        PageInfo pageInfo = new PageInfo(水生相关性生物量List);
        resultMap.put("tHead",fieldList);
        resultMap.put("tBody",水生相关性生物量List);
    ...
    public boolean deleteRow(int rowId) {
        ...
        水生相关性生物量Example s水生相关性生物量Example = new 水生相关性生物量Example();
        水生相关性生物量Example.Criteria criteria = s水生相关性生物量Example.createCriteria();
        criteria.andIdEqualTo(rowId);
        int result =   s水生相关性生物量Mapper.deleteByExample(s水生相关性生物量Example);
    ...
    public boolean updateRow(水生相关性生物量 record) {
        ...
        int result=s水生相关性生物量Mapper.updateByExampleSelective(record,s水生相关性生物量Example);
        return result==1?true:false;
    }

    public boolean insert(水生相关性生物量 record) {
        int result=s水生相关性生物量Mapper.insert(record);
        return result==1?true:false;
    }
...
//        PageHelper.startPage(pageIndex,pageSize);
        List<水生相关性生物量> 水生相关性生物量List=s水生相关性生物量Mapper.selectByExample(s水生相关性生物量Example);
        Collections.sort(水生相关性生物量List, new Comparator<水生相关性生物量>() {
            @Override
            public int compare(水生相关性生物量 o1, 水生相关性生物量 o2) {
                return o1.get采样点位().compareTo(o2.get采样点位());
            }
        });
        String[] fieldList={"采样点位","平均值","最大值","最小值","标准差"};
        String[] fieldList2=EntityUtil.getClassColmun("com.glyk.heos.dal.dao.水生相关性生物量");
    ...
    public Result get水生相关性生物量统计Info2(String place, Date startDate, Date endDate) {
        ...
        Map resultMap=new HashMap();
        水生相关性生物量Example s水生相关性生物量Example=new 水生相关性生物量Example();
        水生相关性生物量Example.Criteria criteria=s水生相关性生物量Example.createCriteria().and日期Between(startDate,endDate).and采样点位EqualTo(place);
//        PageHelper.startPage(pageIndex,pageSize);
        List<水生相关性生物量> 水生相关性生物量List=s水生相关性生物量Mapper.selectByExample(s水生相关性生物量Example);
        List<水生相关性生物量> 水生相关性生物量ListRes=new ArrayList<水生相关性生物量>();
        水生相关性生物量 d1=new 水生相关性生物量();
        水生相关性生物量 d2=new 水生相关性生物量();
        水生相关性生物量 d3=new 水生相关性生物量();
        水生相关性生物量 d4=new 水生相关性生物量();
        String[] fieldList=EntityUtil.getClassColmun("com.glyk.heos.dal.dao.水生相关性生物量");
        List<Double> list=new ArrayList<Double>();
        StaDao sta=null;
        String value="";
...
//                System.out.println(sta.getAverage()+" "+sta.getMax()+" "+sta.getMax()+" "+sta.getMin());
        ...
        d3.set采样点位("最小值");
        d4.set采样点位("标准差");
        水生相关性生物量ListRes.add(d1);
        水生相关性生物量ListRes.add(d2);
        水生相关性生物量ListRes.add(d3);
        水生相关性生物量ListRes.add(d4);
        PageInfo pageInfo = new PageInfo(水生相关性生物量ListRes);
        fieldList[2]="";
        resultMap.put("tHead",fieldList);
        resultMap.put("tBody",水生相关性生物量ListRes);
        result.setTotal((int)pageInfo.getTotal());
        result.setRows(resultMap);
        return result;
    }
