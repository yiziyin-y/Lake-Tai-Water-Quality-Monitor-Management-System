...
(function($){
    ...
    $.extend({
        Hmodal:function(param){
            ...
            //初始化弹框主体
            function init(){
                var mframe='<div class="modal-dialog modal-sm">\n' +
                    ...
                    '                <p>\n' +
                    '                 <span id = "message"> '+ __DEFAULT.body+'</span>\n' +
                    '                </p>\n' +
                    '            </div>\n' +
                    '            <div class="modal-footer">\n' +
                    '\n' +
                    '                  <button type="button" class="btn c-theme-btn c-btn-border-2x c-btn-square c-btn-bold c-btn-uppercase" data-dismiss="modal">关闭</button>\n' +
                    '            </div>\n' +
                    '        </div>\n' +
                    '        <!-- /.modal-content -->\n' +
                    '    </div>';
