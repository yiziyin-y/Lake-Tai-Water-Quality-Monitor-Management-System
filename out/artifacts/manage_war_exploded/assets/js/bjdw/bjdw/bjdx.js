...
jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        url: "heUser/queryUser.action",//组件创建完成之后请求数据的url
        datatype: "json",
        mtype: "post",
        height: 250,
        colNames: [ 'ID', '真实姓名','密码', '性别', '用户名', '部门编号', '手机','座机','操作'],
        colModel: [{
            name: 'id',
            index: 'id',
            hidden: true,
            ...
            name: 'realName', index: 'realName', width: 90, editable: true, sorttype: "String"
        },
            {
                name: 'password', index: 'password', width: 90, editable: true, sorttype: "String"
            },
            {
                name: 'userName', index: 'userName', width: 90, editable: true, sorttype: "String"
            },
            {
                name: 'hcDeptId', index: 'hcDeptId', width: 60, sorttype: "String", editable: true,
            },
            {
                name: 'openId', index: 'openId', width: 90, editable: true, sorttype: "String",

            },

            {
                name: 'phone', index: 'phone', width: 60, sorttype: "Date", editable: true, sortable: false,
            },
            {
                name: 'tel', index: 'tel', width: 60, sorttype: "Date", editable: true, sortable: false,
            },
            {
                name: 'myac',
                index: '',
...
function saveOrUpdate()
{
    ...
    var hcDeptId = $("#hcDeptId").val();
    var phone = $("#phone").val();
    var tel = $("#tel").val();
    if(oper=='edit'){
        $.ajax({
            type: "post",
            url: "/heUser/updateUser.action",
            data: {
                "id": selId,
                "realName": realName,
